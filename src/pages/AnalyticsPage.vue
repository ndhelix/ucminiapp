...
<template>
  <section class="workspace-page"><h1>Подписчики и аналитика</h1><RouterLink to="/reports">Переходы между тарифами</RouterLink>
    ...
    <template v-if="dynamics"><SubscriberChart :labels="dynamics.Labels" :series="dynamics.Series" /><p class="muted">Отписки из подписавшихся за выбранный период, с группировкой по дате подписки — как в CRM.</p></template>
